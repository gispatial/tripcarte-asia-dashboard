...
const data = {
  pixinvent_product_1: {
    img: require("@/assets/images/pages/animal.jpg"),
    title: "G2G ANIMAL GARDEN",
    subtitle: "Booking",
    subtitle_2: "RM18.80 / night",
  },
  pixinvent_product_sales_1: {
    img: require("@/assets/images/pages/almera.png"),
    title: "NISSAN ALMERA",
    subtitle: "LANGKAWI – CAR → RENTAL",
    footer_text_left_value: "$ 93.02",
    footer_text_left_label: "/ night",
    footer_text_right_value: "Fits – 5 Passengers",
    footer_text_right_label: "The rate will be double during peak seasons",
  },
  pixinvent_product_goal_1: {
    img: require("@/assets/images/pages/logo.png"),
    title: '© 2020 Tripcarte Sdn Bhd. All Rights Reserved.',
  ...
  user_detail_89: {
    userImg: require("@/assets/images/pages/refundable.png"),
    name: 'Zoila Legore',
  ...
  user_detail_58: {
    userImg: require("@/assets/images/pages/digital.png"),
  ...
  user_detail_16: {
    userImg: require("@/assets/images/pages/tech.png"),
    name: 'Jonell Binion',
    profession: 'Designer',
  ...
  place_detail_18: {
    overlay_img: require("@/assets/images/pages/dynamic.png"),
