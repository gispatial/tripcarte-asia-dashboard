...
<template>
    <vx-card title="With Badge" code-toggler>
        ...
        <p>You could also change the badge's color by using the property <code>badge-color</code>. You are able to use the <router-link to="/syst/colors">Main Colors</router-link> or <strong>RGB</strong> and <strong>HEX</strong> colors.</p>
