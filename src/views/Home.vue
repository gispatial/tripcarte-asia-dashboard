...
<div id="dashboard-analytics">
  ...
  <div class="vx-col w-full lg:w-1/2 mb-base">
    <vx-card slot="no-body" class="text-center bg-primary-gradient greet-user">
      ...
      <p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">You have done:<p></p><p class=" text-white">Total Redemption This Week - 350 Tickets .+1</text></p>
    </vx-card>
  </div>

    <!-- CARD 2: SUBSCRIBERS GAINED -->
    <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
    <vs-button icon-pack="feather" icon="icon-chevrons-right" icon-after class="shadow-md w-full lg:mt-0 mt-4" href="/apps/reviews/all">Please login to review</vs-button>
    ...
    <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        ...
        <vs-button icon-pack="feather" icon="icon-chevrons-right" icon-after class="shadow-md w-full lg:mt-0 mt-4" href="/syst/ag-grid-table">Please login to review</vs-button>
  ...
  <!-- CARD 2: SUBSCRIBERS GAINED -->
  <div class="vx-col w-full lg:w-1/2 mb-base">
          <statistics-card-line icon="DollarSignIcon" statisticTitle="Total Pending Payout - You must to sign-in to review"></statistics-card-line>
          </div>
