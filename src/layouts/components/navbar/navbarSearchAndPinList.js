export default {
  pages: {
    ...
    data: [
      ...
      {title: "Basic Cards",               url: "/syst/card/basic",             icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Statistics Card",           url: "/syst/card/statistics",        icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Analytics Cards",           url: "/syst/card/analytics",         icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Card Actions",              url: "/syst/card/card-actions",      icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Card Colors",               url: "/syst/card/card-colors",       icon: "FeatherIcon",        is_bookmarked: false},
      {title: "Table",                     url: "/syst/table",                  icon: "GridIcon",           is_bookmarked: false},
      {title: "agGrid Table",              url: "/syst/commissions",          icon: "GridIcon",           is_bookmarked: false},
